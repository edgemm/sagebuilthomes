...
<div id="midwrap">
	...
	<div id="content">
		...
		<!--close leftnav-->
				...
				<h1 id="title">Homes Coming Soon</h1>
				
				<?php // Outputs events posts.
$wpQuery = new WP_Query('category_name=coming-soon&orderby=date&order=DESC&showposts=100');			
if ($wpQuery->have_posts()) {
    ...
    echo '<p>THERE ARE CURRENTLY NO NEW HOMES COMING AVAILABLE.</br> PLEASE CHECK BACK LATER.</br> THANK YOU.</p>';
    echo '</div>';
  }
?>
