<?php /* Template Name: Oregon City Listing Page */ ?>
<?php get_header(); ?>
<?php the_post(); ?>
...
<div id="midwrap">
	...
	<div id="content">
		...
		<?php get_sidebar(); ?>
				...
				<span style="color: black; font-size: 20px; font-style: italic; margin-bottom: 10px; font-weight: bold;">New Oregon City Community- Crabtree Terrace Phase 2</span>
				<div style="height: 20px;"></div>
				<p>8 Lots - 2314 SF to 2608 SF - <a style="color:black;" target="_blank" href="http://goo.gl/maps/1AydP">Map</a></p>
				<div style="height: 20px;"></div>
				<h1 id="title">OREGON CITY HOMES</h1>
				
				<?php the_content(); ?>
				

<?php
  query_posts( array( 'post_type' => 'homes', 'homes_community' => 'oregon-city' ) );
